...
import com.storedetails.service.StoreDetailsService;
@SpringBootTest
class StoreDetailsServiceTest {
	...
	public void getAllStoresDetailsTest() {
		...
		store.setCountry("india");
		store.setPincode("111");
		store.setEmail("tttt@gmail.com");
		
		store1.setStoreId(1235);
		...
		store1.setEmail("pppp@gmail.com");
